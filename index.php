...
if ($_POST['action'] == 'book_appointment' && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_client = "SELECT * FROM appointments WHERE client_phone = '$client_phone' AND appointment_date = '$appointment_date' AND status = 'pending'";
